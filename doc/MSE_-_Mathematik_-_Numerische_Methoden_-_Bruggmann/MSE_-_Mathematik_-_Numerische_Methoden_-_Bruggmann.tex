...
\title{\fbox{\includegraphics[width=0.3\textwidth]{img/TI-89-pocket-calculator-kraftwerk-look.png}}
\bigskip
% \\Programmierung numerischer Methoden zur Approximation und Integration f\"ur den Taschenrechner TI-89
\\Numerische Methoden: 
...
\begin{document}
\pagestyle{empty}
\maketitle % Argument: Seitennummer f\"ur die Erste Seite der Titelei

\begin{abstract}
Diese Arbeit dokumentiert eine Implementation numerischer Methoden zur Approximation (Bisection, Regula falsi und Newton) und Integration (Rechteck-, Trapez-, Tangenten- und Simpson-Verfahren) f\"ur den Taschenrechner TI-89.
...
\section{Allgemeines}
Kenntnisse zur Bedienung des TI-89 werden voraussgesetzt und k\"onnen z.B. im Benutzerhandbuch \cite{AVM99} nachgeschlagen werden, das zum Rechner mitgeliefert wurde. 

Im Programm \verb|nummeth| kann mit \verb|ESC| jeweils zum vorherigen Fenster gewechselt werden. Numerische Eingaben werden jeweils auf ihre G\"ultigkeit gepr\"uft. Bei einer ung\"ultigen Eingabe erscheint eine Fehlermeldung. Danach besteht die M\"oglichkeit, die Eingabe zu korrigieren (siehe Abbildung~\ref{fig:Flowchart}).
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image012.png}
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image036.png}
%   \caption{Dialog Resultat f\"ur die Methode Regula falsi}
%   \label{fig:ResultatApproximationRegulaFalsi}
% \end{figure}
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image038.png}
%   \caption{Dialog Resultat f\"ur die Methode Newton}
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image042.png}
%   \caption{Dialog 'Resultat Trapez-Verfahren’}
%   \label{fig:ResultatIntegrationTrapez}
% \end{figure}
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image044.png}
%   \caption{Dialog 'Resultat Tangenten-Verfahren’}
%   \label{fig:ResultatIntegrationTangente}
% \end{figure}
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.5\textwidth]{img/nummeth_image046.png}
